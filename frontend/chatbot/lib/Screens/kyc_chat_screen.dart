...
// // Add this variable to track if we have a valid applicationId
// int? _applicationId;

// // Update the _addBotMessage method to save bot messages
...
// Future<void> _saveChatMessage(String message, {bool isSystemMessage = false}) async {
//   try {
...
// // Update the _handleSubmitted method to save user messages
...
//   // _pickFile method to handle web platform
...
//     _addBotMessage("KYC application submitted successfully! Application ID: $applicationId");
...
//     // Upload documents code remains the same...
            ...
            children: _idTypes.map((type) {
              return ListTile(
                ...
                onTap: () {
                  ...
                  if (_applicationId != null) {
                    _saveChatMessage("Selected ID Type: $type", isSystemMessage: false);
                  }
...
Is this information correct? Type 'yes' to confirm or 'no' to restart.''');
  ...
  void _showDatePicker() async {
    ...
    if (picked != null) {
      ...
      if (_applicationId != null) {
        _saveChatMessage("Selected DOB: ${DateFormat('dd MMMM yyyy').format(picked)}", 
        ...
        setState(() {
          if (_currentStep == 7) {
            ...
            if (_selectedIdType == 'NIC') {
              ...
              if (_applicationId != null) {
                _saveChatMessage("NIC Front uploaded: $fileName", isSystemMessage: false);
              }
            } else {
              _idDocument = fileName;
              if (kIsWeb) {
              ...
              // Save file upload message if we have an application ID
              if (_applicationId != null) {
                _saveChatMessage("${_selectedIdType} Document uploaded: $fileName", isSystemMessage: false);
              }
            }
          } else if (_currentStep == 8) {
            // Step for NIC back or Bill document
            if (_selectedIdType == 'NIC') {
              ...
              // Save file upload message if we have an application ID
              if (_applicationId != null) {
                _saveChatMessage("NIC Back uploaded: $fileName", isSystemMessage: false);
              }
            } else {
              _billDocument = fileName;
              if (kIsWeb) {
              ...
              // Save file upload message if we have an application ID
              if (_applicationId != null) {
                _saveChatMessage("Bill Document uploaded: $fileName", isSystemMessage: false);
              }
            }
          } else if (_currentStep == 9) {
            // Step for bill document (NIC only)
